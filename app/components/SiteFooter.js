    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:px-8 md:py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          <div>
            <a href="#" className="inline-block">
              <Image
                ...
                width={260}
                height={98}
                className="h-auto w-44 max-h-14 object-contain object-left sm:w-52 sm:max-h-16"
              />
            </a>
            ...
            <a
              ...
              className="mt-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] text-white shadow-md ring-1 ring-black/10 transition hover:scale-105 hover:brightness-110 hover:ring-black/15 motion-reduce:transition-none motion-reduce:hover:scale-100"
          ...
          <div>
            <p className="text-base font-semibold text-neutral-900 dark:text-zinc-100 md:text-lg">Explore</p>
            <ul className="mt-4 space-y-2 text-base md:text-lg">
              ...
              <li>
                <a
                  href="#insights"
                  className="font-bold text-lg text-neutral-900 transition hover:text-brand-green dark:text-zinc-100"
                >
                  Why choose us
                </a>
              </li>
          ...
          <div>
            <p className="text-base font-semibold text-neutral-900 dark:text-zinc-100 md:text-lg">Contact</p>
